...
const I18N_DICT = {
  en: {
    ...
    ds3_meta_records: '<strong>960</strong> verified SKUs',
...
const DATASET_SPECS = {
  ...
  rightmove: {
    ...
    schema: [
      ...
      { field: 'operation_type', type: 'Enum', fill: '100%', desc: 'sale' },
      ...
      { field: 'rooms', type: 'Integer', fill: '95.5%', desc: 'Bedroom count — share carrying a value above zero' },
      { field: 'bathrooms', type: 'Integer', fill: '92.7%', desc: 'Bathroom count — share carrying a value above zero' },
      ...
      { field: 'has_parking', type: 'Boolean', fill: '22.5%', desc: 'Parking or garage flagged in the listing' },
      { field: 'has_terrace', type: 'Boolean', fill: '14.7%', desc: 'Balcony or terrace flagged in the listing' },
      { field: 'has_garden', type: 'Boolean', fill: '24.1%', desc: 'Garden flagged in the listing' },
      ...
      { field: 'region', type: 'String', fill: '100%', desc: '390 distinct regions — counties, boroughs and Scottish shires' },
