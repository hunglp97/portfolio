...
const DATASET_SPECS = {
  ...
  continente: {
    ...
    badge: 'GROCERY-PLP • 31 Fields • 2,059 SKUs',
    ...
    schema: [
      ...
      { field: 'brand', type: 'String', fill: '98.7%', desc: 'Manufacturer brand or private label' },
      ...
      { field: 'category3', type: 'String', fill: '94.7%', desc: 'Tier 3 Granular sub-category' },
      { field: 'category4', type: 'String', fill: '5.3%', desc: 'Tier 4 Specific category classification' },
      { field: 'category5', type: 'String', fill: '—', desc: 'Not published by the source; column preserved, values empty' },
      ...
      { field: 'package_desc', type: 'String', fill: '98.9%', desc: 'Net package volume / weight' },
      ...
      { field: 'ppu', type: 'Float (€/unit)', fill: '94.4%', desc: 'Normalized unit price (€/kg, €/L)' },
      { field: 'unit_type', type: 'Enum', fill: '94.4%', desc: 'kg | L | un | dose' },
      { field: 'promotion_type', type: 'String', fill: '44.0%', desc: 'Promotion indicator (e.g. -10%, Leve 2 Pague 1)' },
      { field: 'promotion_end_date', type: 'ISO Date', fill: '—', desc: 'Not published by the source; column preserved, values empty' },
      { field: 'additional_tags', type: 'String', fill: '1.8%', desc: 'Product tags and seasonal campaign flags' },
